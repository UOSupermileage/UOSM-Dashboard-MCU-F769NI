...
C_SRCS += \
../Core/Modules/CANCallbacks.c 

C_DEPS += \
./Core/Modules/CANCallbacks.d 

OBJS += \
./Core/Modules/CANCallbacks.o 


# Each subdirectory must supply rules for building sources it contributes
Core/Modules/%.o Core/Modules/%.su Core/Modules/%.cyclo: ../Core/Modules/%.c Core/Modules/subdir.mk
...
clean: clean-Core-2f-Modules

clean-Core-2f-Modules:
	-$(RM) ./Core/Modules/CANCallbacks.cyclo ./Core/Modules/CANCallbacks.d ./Core/Modules/CANCallbacks.o ./Core/Modules/CANCallbacks.su

.PHONY: clean-Core-2f-Modules
